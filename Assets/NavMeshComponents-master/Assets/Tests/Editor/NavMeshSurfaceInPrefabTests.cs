...
{
    private const string k_AutoSaveKey = "AutoSave";
    private const string k_ParentFolder = "Assets/Tests/Editor";
    private const string k_TempFolderName = "TempPrefab";
    private string m_TempFolder = k_ParentFolder + "/" + k_TempFolderName;
    private string m_PrefabPath;
    private string m_PreviousScenePath;
    private string m_TempScenePath;
    private int m_TestCounter;
    private const int k_GrayArea = 7;
    private const int k_BrownArea = 10;
    private const int k_RedArea = 18;
    private const int k_OrangeArea = 26;
    private const int k_YellowArea = 30;
    private const int k_PrefabDefaultArea = k_YellowArea;
    ...
    private static void TestNavMeshExistsAloneAtPosition(int expectedArea, Vector3 pos)
    {
    ...
    private static IEnumerator BakeNavMeshAsync(Func<NavMeshSurface> getSurface, int defaultArea)
    {
