...
public class NavMeshModifierVolumeInPrefabTests
{
    ...
    private const string k_TempFolderName = "TempPrefabAndModifiers";
    ...
    private const int k_PinkArea = 3;
    private const int k_GreenArea = 4;
    private const int k_RedArea = 18;
    private const int k_PrefabDefaultArea = k_GreenArea;
